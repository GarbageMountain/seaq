#!/usr/bin/env node
/**
 * Generates 1,000 realistic contacts with:
...
const givenNames = [
  ...
  'Elijah', 'Martha', 'Connor', 'Gloria', 'Cameron', 'Teresa', 'Evan', 'Ann',
  'Gabriel', 'Sara', 'Cole', 'Madison', 'Ian', 'Frances', 'Jordan', 'Kathryn',
  'Max', 'Janice', 'Nolan', 'Jean', 'Blake', 'Abigail', 'Chase', 'Alice',
  'Grant', 'Judy', 'Carter', 'Sophia', 'Miles', 'Grace', 'Leo', 'Denise',
  'Wyatt', 'Amber', 'Eli', 'Doris', 'Finn', 'Marilyn', 'Jude', 'Danielle',
  'Oscar', 'Beverly', 'Hugo', 'Isabella', 'Milo', 'Theresa', 'Felix', 'Diana',
  'Axel', 'Natalie', 'Silas', 'Brittany', 'Reid', 'Charlotte', 'Troy', 'Marie',
  'Seth', 'Kayla', 'Brock', 'Alexis', 'Dante', 'Lori', 'Quinn', 'Allison',
];
...
const outPath = resolve(__dirname, '../src/data/contacts.json');
...
console.log(`  Emails: ${emailCount} total (${(emailCount / 1000).toFixed(1)} avg/contact)`);
console.log(`  Phones: ${phoneCount} total (${(phoneCount / 1000).toFixed(1)} avg/contact)`);
